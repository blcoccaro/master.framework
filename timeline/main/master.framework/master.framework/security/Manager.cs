...
namespace master.framework.security
{
    public static class Manager
    {
        ...
        ///     string cipherText = master.framework.security.Manager.RijndaelEncrypt(plainText, passPhrase, saltValue, hashAlgorithm, passwordIterations, initVector, keySize);
        /// </example>
        public static string RijndaelEncrypt(string plainText, string passPhrase, string saltValue, string hashAlgorithm,
        ...
        ///     int keySize = 256;                // can be 192 or 128
        ///     string cipherText = master.framework.security.Manager.RijndaelEncrypt(plainText, passPhrase, saltValue, hashAlgorithm, passwordIterations, initVector, keySize);
        ///     plainText = master.framework.security.Manager.RijndaelDecrypt(cipherText,passPhrase,saltValue,hashAlgorithm,passwordIterations,initVector,keySize);
        /// </example>
        public static string RijndaelDecrypt(string cipherText, string passPhrase, string saltValue, string hashAlgorithm,
                                    int passwordIterations, string initVector, int keySize)
        {
