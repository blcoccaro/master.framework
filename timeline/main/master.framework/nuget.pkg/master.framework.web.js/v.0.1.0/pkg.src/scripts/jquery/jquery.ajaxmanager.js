...
(function ($) {
    ...
    $.manageAjax._manager.prototype = {
        add: function (url, o) {
            ...
            var internalRequest = o.internalRequest;
            o = $.extend({}, this.opts, o);
            this.opts.internalRequest = internalRequest;
            o.internalRequest = internalRequest;
        ...
        _removeXHR: function (xhrID) {
            ...
            if (this.inProgress == 0) {
                if (this.opts.afterCompleteAll != null || this.opts.afterCompleteAll != undefined) {
                    this.opts.afterCompleteAll(this.opts.internalRequest);
                }
            }
